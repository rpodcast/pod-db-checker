# This file was generated by the {rix} R package v0.17.2 on 2025-10-02
# with following call:
# >rix(r_ver = "4.5.1",
#  > r_pkgs = c("DBI",
#  > "RSQLite",
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-09-29.tar.gz") {};
